...
local EQUIPSLOT_MULTIPLIER_277 = {
  ...
  INVTYPE_HAND = 0.25,
  INVTYPE_FINGER = 0.27,
  INVTYPE_TRINKET = 0.325,
  INVTYPE_CLOAK = 0.25,
  INVTYPE_WEAPON = 0.27,
  INVTYPE_SHIELD = 0.2,
  INVTYPE_2HWEAPON = 0.35,
  INVTYPE_WEAPONMAINHAND = 0.27,
  INVTYPE_WEAPONOFFHAND = 0.15,
  INVTYPE_HOLDABLE = 0.2,
  INVTYPE_RANGED = 0.15,
  INVTYPE_RANGEDRIGHT = 0.15,
  INVTYPE_THROWN = 0.15,
  INVTYPE_RELIC = 0.1,
...
function lib:GetValue(item)
  ...
  elseif level == 297 then
    ...
    low = nil
  elseif level == 290 then
    gp_base = 1000
    high = gp_base * EQUIPSLOT_MULTIPLIER_290[equipLoc]
    low = nil
  end
